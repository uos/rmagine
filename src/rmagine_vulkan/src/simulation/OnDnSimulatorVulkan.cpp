#include "OnDnSimulatorVulkan.hpp"
...
void OnDnSimulatorVulkan::setModel(Memory<OnDnModel, RAM>& sensorMem_ram)
{
    ...
    sensorMem_half_ram[0].origs = Memory<Vec3, VULKAN_DEVICE_LOCAL>(sensorMem_ram[0].origs.size());
