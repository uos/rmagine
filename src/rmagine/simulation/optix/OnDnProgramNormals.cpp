...
OnDnProgramNormals::OnDnProgramNormals(OptixMapPtr map)
{
    const char *kernel =
    #include "kernels/OnDnProgramNormalsString.h"
    ;
...
OnDnProgramNormals::~OnDnProgramNormals()
{
...
void OnDnProgramNormals::updateSBT()
{
    const size_t      raygen_record_size = sizeof( RayGenSbtRecord );
    const size_t      miss_record_size = sizeof( MissSbtRecord );
    const size_t      hitgroup_record_size = sizeof( HitGroupSbtRecord );
