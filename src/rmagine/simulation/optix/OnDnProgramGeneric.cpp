    ...
    const OptixSimulationDataGenericOnDn& flags)
{
    ...
    // computeObjectIds
    options[5] = {};
    options[5].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericOnDn, computeObjectIds);
    options[5].sizeInBytes = sizeof( OptixSimulationDataGenericOnDn::computeObjectIds );
