...
OnDnProgramGeneric::OnDnProgramGeneric(
    OptixMapPtr map,
    const OptixSimulationDataGenericOnDn& flags)
:OnDnProgramGeneric(map->scene(), flags)
{
...
{
    const char *kernel =
    #include "kernels/OnDnProgramGenericString.h"
    ;
    ...
    // computeHits
    options[0] = {};
    options[0].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericOnDn, computeHits);
    options[0].sizeInBytes = sizeof( OptixSimulationDataGenericOnDn::computeHits );
    options[0].boundValuePtr = &flags.computeHits;
    // computeRanges
    options[1] = {};
    options[1].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericOnDn, computeRanges);
    options[1].sizeInBytes = sizeof( OptixSimulationDataGenericOnDn::computeRanges );
    options[1].boundValuePtr = &flags.computeRanges;
    // computePoints
    options[2] = {};
    options[2].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericOnDn, computePoints);
    options[2].sizeInBytes = sizeof( OptixSimulationDataGenericOnDn::computePoints );
    options[2].boundValuePtr = &flags.computePoints;
    // computeNormals
    options[3] = {};
    options[3].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericOnDn, computeNormals);
    options[3].sizeInBytes = sizeof( OptixSimulationDataGenericOnDn::computeNormals );
    options[3].boundValuePtr = &flags.computeNormals;
    // computeFaceIds
    options[4] = {};
    options[4].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericOnDn, computeFaceIds);
    options[4].sizeInBytes = sizeof( OptixSimulationDataGenericOnDn::computeFaceIds );
    options[4].boundValuePtr = &flags.computeFaceIds;
    // computeGeomIds
    options[5] = {};
    options[5].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericOnDn, computeGeomIds);
    options[5].sizeInBytes = sizeof( OptixSimulationDataGenericOnDn::computeGeomIds );
    options[5].boundValuePtr = &flags.computeGeomIds;
    // computeObjectIds
    options[6] = {};
    options[6].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericOnDn, computeObjectIds);
    options[6].sizeInBytes = sizeof( OptixSimulationDataGenericOnDn::computeObjectIds );
