...
PinholeProgramGeneric::PinholeProgramGeneric(
    OptixMapPtr map,
    const OptixSimulationDataGenericPinhole& flags)
:PinholeProgramGeneric(map->scene(), flags)
{
...
{
    const char *kernel =
    #include "kernels/PinholeProgramGenericString.h"
    ;
    ...
    // computeHits
    options[0] = {};
    options[0].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericPinhole, computeHits);
    options[0].sizeInBytes = sizeof( OptixSimulationDataGenericPinhole::computeHits );
    options[0].boundValuePtr = &flags.computeHits;
    // computeRanges
    options[1] = {};
    options[1].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericPinhole, computeRanges);
    options[1].sizeInBytes = sizeof( OptixSimulationDataGenericPinhole::computeRanges );
    options[1].boundValuePtr = &flags.computeRanges;
    // computePoints
    options[2] = {};
    options[2].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericPinhole, computePoints);
    options[2].sizeInBytes = sizeof( OptixSimulationDataGenericPinhole::computePoints );
    options[2].boundValuePtr = &flags.computePoints;
    // computeNormals
    options[3] = {};
    options[3].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericPinhole, computeNormals);
    options[3].sizeInBytes = sizeof( OptixSimulationDataGenericPinhole::computeNormals );
    options[3].boundValuePtr = &flags.computeNormals;
    // computeFaceIds
    options[4] = {};
    options[4].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericPinhole, computeFaceIds);
    options[4].sizeInBytes = sizeof( OptixSimulationDataGenericPinhole::computeFaceIds );
    options[4].boundValuePtr = &flags.computeFaceIds;
    // computeGeomIds
    options[5] = {};
    options[5].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericPinhole, computeGeomIds);
    options[5].sizeInBytes = sizeof( OptixSimulationDataGenericPinhole::computeGeomIds );
    options[5].boundValuePtr = &flags.computeGeomIds;
    // computeObjectIds
    options[6] = {};
    options[6].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericPinhole, computeObjectIds);
    options[6].sizeInBytes = sizeof( OptixSimulationDataGenericPinhole::computeObjectIds );
...
void PinholeProgramGeneric::updateSBT()
{
