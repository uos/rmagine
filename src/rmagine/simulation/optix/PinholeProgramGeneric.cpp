    ...
    const OptixSimulationDataGenericPinhole& flags)
{
    ...
    // computeObjectIds
    options[5] = {};
    options[5].pipelineParamOffsetInBytes = offsetof(OptixSimulationDataGenericPinhole, computeObjectIds);
    options[5].sizeInBytes = sizeof( OptixSimulationDataGenericPinhole::computeObjectIds );
