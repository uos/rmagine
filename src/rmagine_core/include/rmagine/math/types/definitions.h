...
using Matrix5x5f = Matrix_<float, 5, 5>;
using Matrix6x6f = Matrix_<float, 6, 6>;
...
using Matrix5x5d = Matrix_<double, 5, 5>;
using Matrix6x6d = Matrix_<double, 6, 6>;
...
using Matrix5x5 = Matrix_<DefaultFloatType, 5, 5>;
using Matrix6x6 = Matrix_<DefaultFloatType, 6, 6>;
