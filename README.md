...
```console
$ sudo dpkg -i rmagine-core_2.2.0_amd64.deb
```

Then additionally for the Embree backend:

```console
$ sudo dpkg -i rmagine-embree_2.2.0_amd64.deb
```

And if you have a NVIDIA GPU:

```
$ sudo dpkg -i rmagine-cuda_2.2.0_amd64.deb
$ sudo dpkg -i rmagine-optix_2.2.0_amd64.deb
```
